...
const AboutPage = () => {
  return (
      <Box>
        ...
        <Text paddingBottom={'1rem'}>Dragon's Brew isn't just a coffee shop; it's a sanctuary where myth and reality blend seamlessly, where every sip transports you on a journey through legends and fantasies. Whether you're seeking a quick caffeine fix or a tranquil retreat from the urban hustle, Dragon's Brew promises an unforgettable experience steeped in both magic and the art of coffee.</Text>
