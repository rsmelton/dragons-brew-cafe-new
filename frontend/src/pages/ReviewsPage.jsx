...
const ReviewsPage = () => {
  return (
    <>
      ...
      <p className='review-paragraph-padding-bottom' paddingBottom={'1rem'}>Dragon's Brew is my go-to spot for a perfect cup of coffee! The ambiance is cozy with just the right touch of dragon-themed decor that adds a whimsical charm. The baristas are friendly and knowledgeable, always recommending new blends to try. Their Dragon's Fire Latte is my favorite; it's rich and smooth, perfect for starting my day right!</p>
      <p>Name: Deondre North</p>
      <p>Review: ⭐️⭐️⭐️⭐️⭐️</p>
      <p className='review-paragraph-padding-bottom' paddingBottom={'1rem'}>What a gem! Dragon's Brew not only serves amazing coffee but also creates a welcoming atmosphere that feels like a home away from home. The moment you step in, you're greeted with the aroma of freshly ground beans and a smile from the staff. I love their attention to detail, from the unique dragon art on the walls to the carefully curated menu. Whether you're in for a quick espresso or a leisurely afternoon latte, this place delivers excellence every time.</p>
